...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('ups.role:superadmin,admin')->group(function () {
        Route::prefix('master')->group(function () {
            ...
            Route::get('get-teamlead-structure', [MasterController::class, 'getTeamLeadStructure']);
            Route::delete('delete-team-structure/{categoryId}/{teamLeadId}', [MasterController::class, 'deleteTeamStructure']);
        });
    });

    // ─── Team Lead Routes ──────────────────────────────────────────────────────
    Route::middleware('ups.role:teamlead')->group(function () {
        Route::post('tickets/{id}/assign', [TicketController::class, 'assign']);
        Route::post('tickets/{id}/close', [TicketController::class, 'close']);
    });

    // ─── Developer Routes ───────────────────────────────────────────────────────
    Route::middleware('ups.role:developer')->group(function () {
    ...
    Route::middleware('ups.role:applicant,lra,adc')->group(function () {
